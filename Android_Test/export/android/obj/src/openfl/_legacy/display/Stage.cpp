...
HX_STACK_ARG(height,"height")
{
	...
	HX_STACK_LINE(135)
	Dynamic tmp1 = ::openfl::_legacy::display::Stage_obj::lime_stage_request_render_dyn();		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(135)
	this->renderRequest = tmp1;
	HX_STACK_LINE(144)
	Dynamic tmp2 = this->__handle;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(144)
	Dynamic tmp3 = this->__processStageEvent_dyn();		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(144)
	int tmp4 = width;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(144)
	int tmp5 = height;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(144)
	::openfl::_legacy::display::Stage_obj::lime_set_stage_handler(tmp2,tmp3,tmp4,tmp5);
	HX_STACK_LINE(145)
	...
	{
		HX_STACK_LINE(155)
		::openfl::display::Stage3D tmp9 = ::openfl::display::Stage3D_obj::__new();		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(155)
		::openfl::display::Stage3D x = tmp9;		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(155)
		Array< ::Dynamic > tmp10 = this->stage3Ds;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(155)
		::openfl::display::Stage3D tmp11 = x;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(155)
		tmp10->push(tmp11);
	}
}
...
Void Stage_obj::dummyTrace( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(372)
		Dynamic tmp = hx::SourceInfo(HX_HCSTRING("Stage.hx","\xe0","\x5e","\xde","\xbc"),372,HX_HCSTRING("openfl._legacy.display.Stage","\x0e","\x35","\xcf","\x10"),HX_HCSTRING("dummyTrace","\x3d","\x9f","\x05","\x9f"));		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(372)
		::haxe::Log_obj::trace(HX_HCSTRING("","\x00","\x00","\x00","\x00"),tmp);
	}
return null();
}
...
Void Stage_obj::__onJoystick( Dynamic event,::String type){
{
		...
		if (  ( _switch_1==HX_HCSTRING("axisMove","\x52","\x90","\xf4","\x8f"))){
			...
			HX_STACK_LINE(778)
			bool tmp1 = (event->__Field(HX_HCSTRING("code","\x2d","\xb1","\xc4","\x41"), hx::paccDynamic ) >= (int)19);		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(778)
			bool tmp2;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(778)
			if ((tmp1)){
				HX_STACK_LINE(778)
				tmp2 = (event->__Field(HX_HCSTRING("code","\x2d","\xb1","\xc4","\x41"), hx::paccDynamic ) <= (int)22);
			}
			else{
				HX_STACK_LINE(778)
				tmp2 = false;
			...
			if ((tmp2)){
				HX_STACK_LINE(780)
				bool tmp3 = (type == HX_HCSTRING("buttonDown","\x74","\x67","\x64","\xac"));		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(780)
				if ((tmp3)){
					HX_STACK_LINE(782)
					Dynamic _g = event->__Field(HX_HCSTRING("code","\x2d","\xb1","\xc4","\x41"), hx::paccDynamic );		HX_STACK_VAR(_g,"_g");
					HX_STACK_LINE(782)
					Dynamic tmp4 = _g;		HX_STACK_VAR(tmp4,"tmp4");
					HX_STACK_LINE(782)
					switch( (int)(tmp4)){
						case (int)19: {
							HX_STACK_LINE(784)
					...
					switch( (int)(tmp4)){
						case (int)19: {
							HX_STACK_LINE(795)
							int tmp5 = (int)-2;		HX_STACK_VAR(tmp5,"tmp5");
							HX_STACK_LINE(795)
							hx::AndEq(this->__hatValue,tmp5);
						}
						;break;
						case (int)20: {
							HX_STACK_LINE(796)
							int tmp5 = (int)-5;		HX_STACK_VAR(tmp5,"tmp5");
							HX_STACK_LINE(796)
							hx::AndEq(this->__hatValue,tmp5);
						}
						;break;
						case (int)21: {
							HX_STACK_LINE(797)
							int tmp5 = (int)-9;		HX_STACK_VAR(tmp5,"tmp5");
							HX_STACK_LINE(797)
							hx::AndEq(this->__hatValue,tmp5);
						}
						;break;
						case (int)22: {
							HX_STACK_LINE(798)
							int tmp5 = (int)-3;		HX_STACK_VAR(tmp5,"tmp5");
							HX_STACK_LINE(798)
							hx::AndEq(this->__hatValue,tmp5);
						}
						;break;
				...
				HX_STACK_LINE(804)
				int tmp4 = this->__hatValue;		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(804)
				event->__FieldRef(HX_HCSTRING("value","\x71","\x7f","\xb8","\x31")) = tmp4;
				HX_STACK_LINE(805)
				Dynamic tmp5 = event;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(805)
				this->__onJoystick(tmp5,HX_HCSTRING("hatMove","\x0c","\x98","\x0b","\xab"));
				HX_STACK_LINE(806)
				return null();
			}
			else{
				HX_STACK_LINE(810)
				hx::SubEq(event->__FieldRef(HX_HCSTRING("code","\x2d","\xb1","\xc4","\x41")),(int)96);
			}
			HX_STACK_LINE(815)
			::openfl::_legacy::events::JoystickEvent tmp3 = ::openfl::_legacy::events::JoystickEvent_obj::__new(type,false,false,event->__Field(HX_HCSTRING("id","\xdb","\x5b","\x00","\x00"), hx::paccDynamic ),event->__Field(HX_HCSTRING("code","\x2d","\xb1","\xc4","\x41"), hx::paccDynamic ),null(),null(),null());		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(815)
			joystickEvent = tmp3;
		}
;
...
Void Stage_obj::__setActive( bool value){
{
		...
		HX_STACK_LINE(1129)
		::openfl::_legacy::display::Stage _g = hx::ObjectPtr<OBJ_>(this);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(1131)
		bool tmp = this->active;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(1131)
		...
		if ((tmp2)){
			...
			if ((tmp9)){
				...
				this->__pollTimers();
				HX_STACK_LINE(1150)
				::openfl::_legacy::display::InteractiveObject tmp10 = this->get_focus();		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(1150)
				::openfl::_legacy::display::InteractiveObject focus = tmp10;		HX_STACK_VAR(focus,"focus");
				HX_STACK_LINE(1151)
				bool tmp11 = (focus != null());		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(1151)
				bool tmp12;		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(1151)
				if ((tmp11)){
					HX_STACK_LINE(1151)
					tmp12 = focus->get_needsSoftKeyboard();
				}
				else{
					HX_STACK_LINE(1151)
					tmp12 = false;
				...
				if ((tmp12)){
					...
					HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_Function_4_1,::openfl::_legacy::display::InteractiveObject,focus,::openfl::_legacy::display::Stage,_g)
					int __ArgCount() const { return 0; }
					Void run(){
						HX_STACK_FRAME("*","_Function_4_1",0x520333fa,"*._Function_4_1","openfl/_legacy/display/Stage.hx",1153,0x8b30a073)
						{
							HX_STACK_LINE(1155)
							::openfl::_legacy::display::InteractiveObject tmp13 = focus;		HX_STACK_VAR(tmp13,"tmp13");
							HX_STACK_LINE(1155)
							::openfl::_legacy::display::InteractiveObject tmp14 = _g->get_focus();		HX_STACK_VAR(tmp14,"tmp14");
							HX_STACK_LINE(1155)
							bool tmp15 = (tmp13 == tmp14);		HX_STACK_VAR(tmp15,"tmp15");
							HX_STACK_LINE(1155)
							if ((tmp15)){
								HX_STACK_LINE(1157)
								_g->requestSoftKeyboard();
							}
						}
						return null();
					}
...
::openfl::_legacy::geom::Rectangle Stage_obj::get_softKeyboardRect( ){
	...
	HX_STACK_LINE(1395)
	int tmp2 = ::openfl::_legacy::display::Stage_obj::lime_get_softkeyboardheight();		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(1395)
	int height = tmp2;		HX_STACK_VAR(height,"height");
	HX_STACK_LINE(1397)
	bool tmp3 = (height > (int)0);		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(1397)
	if ((tmp3)){
		HX_STACK_LINE(1399)
		::openfl::_legacy::geom::Rectangle tmp4 = this->__softKeyboardRect;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(1399)
		tmp4->x = (int)0;
		HX_STACK_LINE(1400)
		int tmp5 = this->get_stageHeight();		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(1400)
		int tmp6 = height;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(1400)
		int tmp7 = (tmp5 - tmp6);		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(1400)
		::openfl::_legacy::geom::Rectangle tmp8 = this->__softKeyboardRect;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(1400)
		tmp8->y = tmp7;
		HX_STACK_LINE(1401)
		int tmp9 = this->get_stageWidth();		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(1401)
		::openfl::_legacy::geom::Rectangle tmp10 = this->__softKeyboardRect;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(1401)
		tmp10->width = tmp9;
		HX_STACK_LINE(1402)
		::openfl::_legacy::geom::Rectangle tmp11 = this->__softKeyboardRect;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(1402)
		tmp11->height = height;
	}
	else{
		...
		tmp4->x = (int)0;
		HX_STACK_LINE(1407)
		::openfl::_legacy::geom::Rectangle tmp5 = this->__softKeyboardRect;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(1407)
		tmp5->y = (int)0;
		HX_STACK_LINE(1408)
		::openfl::_legacy::geom::Rectangle tmp6 = this->__softKeyboardRect;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(1408)
		tmp6->width = (int)0;
		HX_STACK_LINE(1409)
		::openfl::_legacy::geom::Rectangle tmp7 = this->__softKeyboardRect;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(1409)
		tmp7->height = (int)0;
	}
	HX_STACK_LINE(1414)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(Stage_obj,__hatValue),HX_HCSTRING("__hatValue","\x36","\x99","\xa4","\xc7")},
...
struct _Function_0_2{
	...
	lime_get_softkeyboardheight= ::openfl::_legacy::utils::JNI_obj::createStaticMethod(HX_HCSTRING("org.haxe.lime.GameActivity","\xfc","\x2b","\x70","\xcc"),HX_HCSTRING("getSoftKeyboardHeight","\xae","\xe8","\xc0","\x7a"),HX_HCSTRING("()F","\x25","\x7e","\x1e","\x00"),null(),null());
}
