...
{
		HX_STACK_FRAME("MenuState","clickOptions",0xe3ab4a12,"MenuState.clickOptions","MenuState.hx",43,0xdfbcb22c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(43)
...
{
		HX_STACK_FRAME("MenuState","clickPlay",0x5f6a9ec0,"MenuState.clickPlay","MenuState.hx",48,0xdfbcb22c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(48)
