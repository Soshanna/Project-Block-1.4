...
Void OptionsState_obj::create( ){
{
		...
		HX_STACK_LINE(49)
		Float tmp43 = (tmp42 + (int)45);		HX_STACK_VAR(tmp43,"tmp43");
		HX_STACK_LINE(49)
		...
		HX_STACK_LINE(75)
		tmp98->fade((int)-16777216,((Float).33),true,null(),null());
		HX_STACK_LINE(76)
		this->super::create();
	}
return null();
...
{
		HX_STACK_FRAME("OptionsState","clickClearData",0x24baad0a,"OptionsState.clickClearData","OptionsState.hx",80,0x342db2ab)
		HX_STACK_THIS(this)
		HX_STACK_LINE(81)
...
{
		HX_STACK_FRAME("OptionsState","clickMenu",0x491f53cc,"OptionsState.clickMenu","OptionsState.hx",87,0x342db2ab)
		HX_STACK_THIS(this)
		HX_STACK_LINE(88)
...
{
		HX_STACK_FRAME("OptionsState","clickVolumeDown",0x7a47b149,"OptionsState.clickVolumeDown","OptionsState.hx",95,0x342db2ab)
		HX_STACK_THIS(this)
		HX_STACK_LINE(96)
		{
			HX_STACK_LINE(96)
...
{
		HX_STACK_FRAME("OptionsState","clickVolumeUp",0x9ac24782,"OptionsState.clickVolumeUp","OptionsState.hx",102,0x342db2ab)
		HX_STACK_THIS(this)
		HX_STACK_LINE(103)
		{
			HX_STACK_LINE(103)
...
{
		HX_STACK_FRAME("OptionsState","updateVolume",0x0aa1d81e,"OptionsState.updateVolume","OptionsState.hx",109,0x342db2ab)
		HX_STACK_THIS(this)
		HX_STACK_LINE(110)
		::flixel::_system::frontEnds::SoundFrontEnd tmp = ::flixel::FlxG_obj::sound;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(110)
