...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Android_Test", "com.Android.Test", "0.0.1");
		...
		telemetryConfig.app_name = "Android_Test";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Android_Test", null, { width: 640, height: 480 });
