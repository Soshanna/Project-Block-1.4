...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("F.Neeleman", "CastleCare", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "CastleCare";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "CastleCare", null, { width: 1280, height: 720 });
