...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/img/ArchitectTutTalk.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/img/CatTalkTut.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/img/DoctorTutTalk.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/img/FlowerUpgrade.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/img/FlowerUpgradeDONE.png", "assets/img/FlowerUpgradeDONE.png");
			type.set ("assets/img/FlowerUpgradeDONE.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/img/flower_Plant_Thing.png", "assets/img/flower_Plant_Thing.png");
			type.set ("assets/img/flower_Plant_Thing.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/img/Minigame/DestroyImagePoef.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/img/MoneyBar.png", Reflect.field (AssetType, "image".toUpperCase ()));
