...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/images/room.jpg", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/img/Characters/bever-button.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/img/Characters/duck-button.png", "assets/img/Characters/duck-button.png");
			type.set ("assets/img/Characters/duck-button.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/img/Characters/NPC-Duck.png", "assets/img/Characters/NPC-Duck.png");
			type.set ("assets/img/Characters/NPC-Duck.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/img/Characters/penguin-button.png", "assets/img/Characters/penguin-button.png");
			type.set ("assets/img/Characters/penguin-button.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/img/Characters/plaguepenguinnew.png", "assets/img/Characters/plaguepenguinnew.png");
			type.set ("assets/img/Characters/plaguepenguinnew.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/img/Characters/turtle-button.png", "assets/img/Characters/turtle-button.png");
			type.set ("assets/img/Characters/turtle-button.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/img/Characters/turtle.png", "assets/img/Characters/turtle.png");
			type.set ("assets/img/Characters/turtle.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/img/room1-1.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/img/room2-1.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/img/room3-1.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/img/room4-1.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/img/room5-1.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/img/room6-1.png", Reflect.field (AssetType, "image".toUpperCase ()));
