...
{
HX_STACK_FRAME("upgrade.UpgradeRoomState","new",0x49fea8de,"upgrade.UpgradeRoomState.new","upgrade/UpgradeRoomState.hx",13,0x913340f1)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("upgrade.UpgradeRoomState","create",0x3204713e,"upgrade.UpgradeRoomState.create","upgrade/UpgradeRoomState.hx",18,0x913340f1)
		HX_STACK_THIS(this)
		HX_STACK_LINE(19)
...
{
		HX_STACK_FRAME("upgrade.UpgradeRoomState","clickBack",0x98fd918d,"upgrade.UpgradeRoomState.clickBack","upgrade/UpgradeRoomState.hx",30,0x913340f1)
		HX_STACK_THIS(this)
		HX_STACK_LINE(31)
		...
		Void run(){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","upgrade/UpgradeRoomState.hx",32,0x913340f1)
			{
				HX_STACK_LINE(32)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::flixel::text::FlxText*/ ,(int)offsetof(UpgradeRoomState_obj,_txtTitle),HX_HCSTRING("_txtTitle","\x67","\xb8","\x4f","\xb5")},
