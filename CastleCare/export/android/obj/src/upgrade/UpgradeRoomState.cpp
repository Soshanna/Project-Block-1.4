...
{
HX_STACK_FRAME("upgrade.UpgradeRoomState","new",0x49fea8de,"upgrade.UpgradeRoomState.new","upgrade/UpgradeRoomState.hx",15,0x913340f1)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("upgrade.UpgradeRoomState","clickBack",0x98fd918d,"upgrade.UpgradeRoomState.clickBack","upgrade/UpgradeRoomState.hx",39,0x913340f1)
		HX_STACK_THIS(this)
		HX_STACK_LINE(40)
		...
		Void run(){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","upgrade/UpgradeRoomState.hx",41,0x913340f1)
			{
				HX_STACK_LINE(41)
