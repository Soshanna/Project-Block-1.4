...
{
HX_STACK_FRAME("upgrade.UpgradeInteriorState","new",0x54e93729,"upgrade.UpgradeInteriorState.new","upgrade/UpgradeInteriorState.hx",15,0xe6048086)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("upgrade.UpgradeInteriorState","clickBack",0xc6106a18,"upgrade.UpgradeInteriorState.clickBack","upgrade/UpgradeInteriorState.hx",39,0xe6048086)
		HX_STACK_THIS(this)
		HX_STACK_LINE(40)
		...
		Void run(){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","upgrade/UpgradeInteriorState.hx",41,0xe6048086)
			{
				HX_STACK_LINE(41)
