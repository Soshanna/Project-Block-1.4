...
{
HX_STACK_FRAME("upgrade.UpgradeInteriorState","new",0x54e93729,"upgrade.UpgradeInteriorState.new","upgrade/UpgradeInteriorState.hx",14,0xe6048086)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("upgrade.UpgradeInteriorState","create",0x6339a3d3,"upgrade.UpgradeInteriorState.create","upgrade/UpgradeInteriorState.hx",21,0xe6048086)
		HX_STACK_THIS(this)
		HX_STACK_LINE(22)
...
{
		HX_STACK_FRAME("upgrade.UpgradeInteriorState","clickBack",0xc6106a18,"upgrade.UpgradeInteriorState.clickBack","upgrade/UpgradeInteriorState.hx",36,0xe6048086)
		HX_STACK_THIS(this)
		HX_STACK_LINE(37)
		...
		Void run(){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","upgrade/UpgradeInteriorState.hx",38,0xe6048086)
			{
				HX_STACK_LINE(38)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::PlayState*/ ,(int)offsetof(UpgradeInteriorState_obj,state),HX_HCSTRING("state","\x11","\x76","\x0b","\x84")},
	{hx::fsInt,(int)offsetof(UpgradeInteriorState_obj,currency),HX_HCSTRING("currency","\x51","\x07","\x45","\x9b")},
	{hx::fsObject /*::flixel::ui::FlxButton*/ ,(int)offsetof(UpgradeInteriorState_obj,backButton),HX_HCSTRING("backButton","\x79","\x47","\x6a","\x18")},
	{hx::fsObject /*::flixel::FlxSprite*/ ,(int)offsetof(UpgradeInteriorState_obj,_bkgrOver),HX_HCSTRING("_bkgrOver","\x07","\x53","\x60","\x95")},
	{ hx::fsUnknown, 0, null()}
};
