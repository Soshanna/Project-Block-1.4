...
{
HX_STACK_FRAME("upgrade.UpgradeCharacterState","new",0x2d62dfe4,"upgrade.UpgradeCharacterState.new","upgrade/UpgradeCharacterState.hx",13,0x79bbe30d)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("upgrade.UpgradeCharacterState","create",0xe3d3e1f8,"upgrade.UpgradeCharacterState.create","upgrade/UpgradeCharacterState.hx",18,0x79bbe30d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(19)
		::flixel::text::FlxText tmp = ::flixel::text::FlxText_obj::__new((int)20,(int)0,(int)0,HX_HCSTRING("Upgrade Character Screen","\x67","\xd7","\x3f","\x02"),(int)15,null());		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(19)
		this->_txtTitle = tmp;
		HX_STACK_LINE(20)
...
{
		HX_STACK_FRAME("upgrade.UpgradeCharacterState","clickBack",0x3565d113,"upgrade.UpgradeCharacterState.clickBack","upgrade/UpgradeCharacterState.hx",30,0x79bbe30d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(31)
		...
		Void run(){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","upgrade/UpgradeCharacterState.hx",32,0x79bbe30d)
			{
				HX_STACK_LINE(32)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::flixel::text::FlxText*/ ,(int)offsetof(UpgradeCharacterState_obj,_txtTitle),HX_HCSTRING("_txtTitle","\x67","\xb8","\x4f","\xb5")},
