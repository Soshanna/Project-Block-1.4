...
{
HX_STACK_FRAME("upgrade.UpgradeCharacterState","new",0x2d62dfe4,"upgrade.UpgradeCharacterState.new","upgrade/UpgradeCharacterState.hx",14,0x79bbe30d)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("upgrade.UpgradeCharacterState","clickBack",0x3565d113,"upgrade.UpgradeCharacterState.clickBack","upgrade/UpgradeCharacterState.hx",36,0x79bbe30d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(37)
		...
		Void run(){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","upgrade/UpgradeCharacterState.hx",38,0x79bbe30d)
			{
				HX_STACK_LINE(38)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::PlayState*/ ,(int)offsetof(UpgradeCharacterState_obj,state),HX_HCSTRING("state","\x11","\x76","\x0b","\x84")},
