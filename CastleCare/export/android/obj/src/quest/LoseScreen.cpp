...
Void LoseScreen_obj::__construct()
{
HX_STACK_FRAME("quest.LoseScreen","new",0xaad897bf,"quest.LoseScreen.new","quest/LoseScreen.hx",19,0xd94137f0)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(20)
...
hx::ObjectPtr< LoseScreen_obj > LoseScreen_obj::__new()
...
{
		HX_STACK_FRAME("quest.LoseScreen","buttonPress",0xd4ecd290,"quest.LoseScreen.buttonPress","quest/LoseScreen.hx",39,0xd94137f0)
		HX_STACK_THIS(this)
		HX_STACK_LINE(40)
		...
		Void run(){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","quest/LoseScreen.hx",42,0xd94137f0)
			{
				HX_STACK_LINE(42)
