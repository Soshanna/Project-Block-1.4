...
Void FlxGame_obj::create( Dynamic _){
{
		...
		HX_STACK_LINE(292)
		tmp5->set_scaleMode(::openfl::_legacy::display::StageScaleMode_obj::NO_SCALE);
		HX_STACK_LINE(293)
		::openfl::_legacy::display::Stage tmp6 = this->get_stage();		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(293)
		tmp6->set_align(::openfl::_legacy::display::StageAlign_obj::TOP_LEFT);
		HX_STACK_LINE(294)
		...
		{
			HX_STACK_LINE(300)
			::openfl::_legacy::display::Sprite tmp10 = this->postProcessLayer;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(300)
			this->addChild(tmp10);
		}
		HX_STACK_LINE(328)
		...
		HX_STACK_LINE(328)
		::String tmp11 = ::openfl::_legacy::events::Event_obj::DEACTIVATE;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(328)
		Dynamic tmp12 = this->onFocusLost_dyn();		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(328)
		tmp10->addEventListener(tmp11,tmp12,null(),null(),null());
		HX_STACK_LINE(329)
		::openfl::_legacy::display::Stage tmp13 = this->get_stage();		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(329)
		::String tmp14 = ::openfl::_legacy::events::Event_obj::ACTIVATE;		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(329)
		Dynamic tmp15 = this->onFocus_dyn();		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(329)
		...
		HX_STACK_LINE(333)
		{
			...
			HX_STACK_LINE(333)
			tmp16->__Field(HX_HCSTRING("preGameReset","\xda","\x1b","\xe3","\xc1"), hx::paccDynamic )->__Field(HX_HCSTRING("dispatch","\xba","\xce","\x63","\x1e"), hx::paccDynamic )();
			HX_STACK_LINE(333)
			bool tmp17 = this->_skipSplash;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(333)
			...
			if ((tmp18)){
				HX_STACK_LINE(333)
				::hx::Class tmp20 = ::flixel::_system::FlxSplash_obj::nextState;		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(333)
				::hx::Class tmp21 = tmp20;		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(333)
				tmp19 = (tmp21 != null());
			}
			else{
			...
			if ((tmp19)){
				HX_STACK_LINE(333)
				::hx::Class tmp20 = this->_initialState;		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(333)
				::flixel::FlxState tmp21 = ::Type_obj::createInstance(tmp20,cpp::ArrayBase_obj::__new());		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(333)
				this->_requestedState = tmp21;
				HX_STACK_LINE(333)
				::hx::Class tmp22 = ::flixel::_system::FlxSplash_obj::nextState;		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(333)
				...
				::hx::Class tmp20 = this->_initialState;		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(333)
				::flixel::_system::FlxSplash_obj::nextState = tmp20;
				HX_STACK_LINE(333)
				::flixel::_system::FlxSplash tmp21 = ::flixel::_system::FlxSplash_obj::__new(null());		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(333)
				this->_requestedState = tmp21;
				HX_STACK_LINE(333)
			...
			HX_STACK_LINE(333)
			::flixel::_system::frontEnds::SignalFrontEnd tmp20 = ::flixel::FlxG_obj::signals;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(333)
			tmp20->__Field(HX_HCSTRING("postGameReset","\xfd","\x07","\x96","\xc9"), hx::paccDynamic )->__Field(HX_HCSTRING("dispatch","\xba","\xce","\x63","\x1e"), hx::paccDynamic )();
		}
		HX_STACK_LINE(334)
		this->switchState();
		HX_STACK_LINE(336)
		int tmp16 = ::flixel::FlxG_obj::updateFramerate;		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(336)
		int tmp17 = ::flixel::FlxG_obj::drawFramerate;		HX_STACK_VAR(tmp17,"tmp17");
		HX_STACK_LINE(336)
		...
		HX_STACK_LINE(342)
		::String tmp20 = ::openfl::_legacy::events::Event_obj::ENTER_FRAME;		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(342)
		Dynamic tmp21 = this->onEnterFrame_dyn();		HX_STACK_VAR(tmp21,"tmp21");
		HX_STACK_LINE(342)
		...
		HX_STACK_LINE(346)
		::String tmp23 = ::openfl::_legacy::events::Event_obj::RESIZE;		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(346)
		Dynamic tmp24 = this->onResize_dyn();		HX_STACK_VAR(tmp24,"tmp24");
		HX_STACK_LINE(346)
		...
		HX_STACK_LINE(349)
		int tmp30 = tmp29->get_stageHeight();		HX_STACK_VAR(tmp30,"tmp30");
		HX_STACK_LINE(349)
		this->resizeGame(tmp27,tmp30);
		HX_STACK_LINE(351)
		::String tmp31 = ::openfl::_legacy::events::Event_obj::CHANGE;		HX_STACK_VAR(tmp31,"tmp31");
		HX_STACK_LINE(351)
		::flixel::_system::frontEnds::BitmapFrontEnd tmp32 = ::flixel::FlxG_obj::bitmap;		HX_STACK_VAR(tmp32,"tmp32");
		HX_STACK_LINE(351)
		Dynamic tmp33 = tmp32->__Field(HX_HCSTRING("onAssetsReload","\xfb","\x33","\x88","\x63"), hx::paccDynamic );		HX_STACK_VAR(tmp33,"tmp33");
		HX_STACK_LINE(351)
		::openfl::_legacy::Assets_obj::addEventListener(tmp31,tmp33,null(),null(),null());
	}
return null();
}
...
Void FlxGame_obj::onFocus( Dynamic _){
{
		...
		HX_STACK_ARG(_,"_")
		HX_STACK_LINE(374)
		Dynamic tmp = _;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(374)
		this->onResize(tmp);
		HX_STACK_LINE(377)
		this->_lostFocus = false;
		...
		HX_STACK_LINE(378)
		tmp1->__Field(HX_HCSTRING("focusGained","\x96","\xec","\x66","\xa1"), hx::paccDynamic )->__Field(HX_HCSTRING("dispatch","\xba","\xce","\x63","\x1e"), hx::paccDynamic )();
		HX_STACK_LINE(379)
		::flixel::FlxState tmp2 = this->_state;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(379)
		tmp2->onFocus();
		HX_STACK_LINE(381)
