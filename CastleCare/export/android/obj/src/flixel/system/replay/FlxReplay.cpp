...
Void FlxReplay_obj::recordFrame( ){
{
		...
		HX_STACK_LINE(163)
		bool tmp = continueFrame;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(163)
		if ((tmp)){
			HX_STACK_LINE(165)
			(this->frame)++;
		...
		HX_STACK_LINE(169)
		::flixel::_system::replay::FrameRecord tmp1 = ::flixel::_system::replay::FrameRecord_obj::__new();		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(169)
		int tmp2 = (this->frame)++;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(169)
		::flixel::_system::replay::FrameRecord tmp3 = tmp1->__Field(HX_HCSTRING("create","\xfc","\x66","\x0f","\x7c"), hx::paccDynamic )(tmp2,null(),null());		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(169)
		::flixel::_system::replay::FrameRecord frameRecorded = tmp3;		HX_STACK_VAR(frameRecorded,"frameRecorded");
		HX_STACK_LINE(177)
		int tmp4 = (this->frameCount)++;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(177)
		::flixel::_system::replay::FrameRecord tmp5 = frameRecorded;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(177)
		hx::IndexRef((this->_frames).mPtr,tmp4) = tmp5;
		HX_STACK_LINE(179)
		int tmp6 = this->frameCount;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(179)
		int tmp7 = this->_capacity;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(179)
		...
		if ((tmp8)){
			...
			hx::MultEq(this->_capacity,(int)2);
			HX_STACK_LINE(182)
			int tmp9 = this->_capacity;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(182)
			::flixel::util::FlxArrayUtil_obj::setLength_flixel_system_replay_FrameRecord(this->_frames,tmp9);
		}
	}
return null();
}
