...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(74)
	{
		...
		HX_STACK_LINE(74)
		Dynamic tmp16 = this->clear_dyn();		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(74)
	...
	HX_STACK_LINE(77)
	::openfl::_legacy::display::Bitmap tmp15 = this->_handle;		HX_STACK_VAR(tmp15,"tmp15");
	HX_STACK_LINE(77)
	this->removeChild(tmp15);
	HX_STACK_LINE(78)
	::openfl::_legacy::display::Bitmap tmp16 = this->_handle;		HX_STACK_VAR(tmp16,"tmp16");
	HX_STACK_LINE(78)
	this->addChild(tmp16);
	HX_STACK_LINE(80)
	::openfl::_legacy::display::Bitmap tmp17 = this->_shadow;		HX_STACK_VAR(tmp17,"tmp17");
	HX_STACK_LINE(80)
...
Void BitmapLog_obj::destroy( ){
{
		...
		HX_STACK_LINE(144)
		{
			...
			HX_STACK_LINE(144)
			Dynamic tmp7 = this->clear_dyn();		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(144)
			tmp6->__Field(HX_HCSTRING("stateSwitched","\x84","\x32","\x02","\x37"), hx::paccDynamic )->__Field(HX_HCSTRING("remove","\x44","\x9c","\x88","\x04"), hx::paccDynamic )(tmp7);
		}
	}
return null();
}
...
Void BitmapLog_obj::resize( Float Width,Float Height){
{
		...
		HX_STACK_LINE(180)
		Float tmp27 = (tmp26 + (int)43);		HX_STACK_VAR(tmp27,"tmp27");
		HX_STACK_LINE(180)
		tmp21->set_x(tmp27);
		HX_STACK_LINE(182)
