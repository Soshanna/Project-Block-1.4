...
Void Stats_obj::update( ){
{
		...
		if ((tmp8)){
			...
			HX_STACK_LINE(262)
			::flixel::_system::debug::stats::StatsGraph tmp22 = this->memoryGraph;		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(262)
			...
			HX_STACK_LINE(292)
			bool tmp35 = ::flixel::FlxG_obj::renderTile;		HX_STACK_VAR(tmp35,"tmp35");
			HX_STACK_LINE(292)
			if ((tmp35)){
				HX_STACK_LINE(294)
				{
					...
					while((true)){
						...
						HX_STACK_LINE(296)
						int tmp40 = this->_drawCalls->__GetItem(i);		HX_STACK_VAR(tmp40,"tmp40");
						HX_STACK_LINE(296)
						hx::AddEq(this->drawCallsCount,tmp40);
					}
				}
				HX_STACK_LINE(298)
				int tmp36 = this->drawCallsCount;		HX_STACK_VAR(tmp36,"tmp36");
				HX_STACK_LINE(298)
				int tmp37 = this->_drawCallsMarker;		HX_STACK_VAR(tmp37,"tmp37");
				HX_STACK_LINE(298)
				Float tmp38 = (Float(tmp36) / Float(tmp37));		HX_STACK_VAR(tmp38,"tmp38");
				HX_STACK_LINE(298)
				int tmp39 = ::Std_obj::_int(tmp38);		HX_STACK_VAR(tmp39,"tmp39");
				HX_STACK_LINE(298)
				this->drawCallsCount = tmp39;
			}
			HX_STACK_LINE(301)
			this->_updateMarker = (int)0;
			HX_STACK_LINE(302)
			...
			this->_visibleObjectMarker = (int)0;
			HX_STACK_LINE(305)
			bool tmp36 = ::flixel::FlxG_obj::renderTile;		HX_STACK_VAR(tmp36,"tmp36");
			HX_STACK_LINE(305)
			if ((tmp36)){
				HX_STACK_LINE(307)
				this->_drawCallsMarker = (int)0;
