...
Void FlxSplash_obj::create( ){
{
		...
		HX_STACK_LINE(50)
		Dynamic tmp5 = this->drawGreen_dyn();		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(50)
		Dynamic tmp6 = this->drawYellow_dyn();		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(50)
		Dynamic tmp7 = this->drawRed_dyn();		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(50)
		Dynamic tmp8 = this->drawBlue_dyn();		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(50)
		Dynamic tmp9 = this->drawLightBlue_dyn();		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(50)
		this->_functions = cpp::ArrayBase_obj::__new().Add(tmp5).Add(tmp6).Add(tmp7).Add(tmp8).Add(tmp9);
		HX_STACK_LINE(52)
		{
			HX_STACK_LINE(52)
			...
			while((true)){
				...
				HX_STACK_LINE(52)
				Float tmp12 = _g1->__get(_g);		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(52)
		...
		HX_STACK_LINE(57)
		int stageWidth = tmp12;		HX_STACK_VAR(stageWidth,"stageWidth");
		HX_STACK_LINE(58)
		...
		HX_STACK_LINE(58)
		int stageHeight = tmp15;		HX_STACK_VAR(stageHeight,"stageHeight");
		HX_STACK_LINE(60)
		::openfl::_legacy::display::Sprite tmp16 = ::openfl::_legacy::display::Sprite_obj::__new();		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(60)
		this->_sprite = tmp16;
		HX_STACK_LINE(61)
		...
		HX_STACK_LINE(61)
		::openfl::_legacy::display::Sprite tmp19 = this->_sprite;		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(61)
		tmp18->addChild(tmp19);
		HX_STACK_LINE(62)
		...
		this->_gfx = tmp21;
		HX_STACK_LINE(64)
		::openfl::_legacy::text::TextField tmp22 = ::openfl::_legacy::text::TextField_obj::__new();		HX_STACK_VAR(tmp22,"tmp22");
		HX_STACK_LINE(64)
		this->_text = tmp22;
		HX_STACK_LINE(65)
		::openfl::_legacy::text::TextField tmp23 = this->_text;		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(65)
		tmp23->set_selectable(false);
		HX_STACK_LINE(66)
		::openfl::_legacy::text::TextField tmp24 = this->_text;		HX_STACK_VAR(tmp24,"tmp24");
		HX_STACK_LINE(66)
		tmp24->set_embedFonts(true);
		HX_STACK_LINE(67)
		::String tmp25 = ::flixel::_system::FlxAssets_obj::FONT_DEFAULT;		HX_STACK_VAR(tmp25,"tmp25");
		HX_STACK_LINE(67)
		::openfl::_legacy::text::TextFormat tmp26 = ::openfl::_legacy::text::TextFormat_obj::__new(tmp25,(int)16,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(tmp26,"tmp26");
		HX_STACK_LINE(67)
		::openfl::_legacy::text::TextFormat dtf = tmp26;		HX_STACK_VAR(dtf,"dtf");
		HX_STACK_LINE(68)
		dtf->align = HX_HCSTRING("center","\xd5","\x25","\xdb","\x05");
		HX_STACK_LINE(69)
		::openfl::_legacy::text::TextField tmp27 = this->_text;		HX_STACK_VAR(tmp27,"tmp27");
		HX_STACK_LINE(69)
		::openfl::_legacy::text::TextFormat tmp28 = dtf;		HX_STACK_VAR(tmp28,"tmp28");
		HX_STACK_LINE(69)
		tmp27->set_defaultTextFormat(tmp28);
		HX_STACK_LINE(70)
		::openfl::_legacy::text::TextField tmp29 = this->_text;		HX_STACK_VAR(tmp29,"tmp29");
		HX_STACK_LINE(70)
		tmp29->set_text(HX_HCSTRING("HaxeFlixel","\x42","\x8f","\x0c","\xac"));
		HX_STACK_LINE(71)
		...
		HX_STACK_LINE(71)
		::openfl::_legacy::text::TextField tmp32 = this->_text;		HX_STACK_VAR(tmp32,"tmp32");
		HX_STACK_LINE(71)
		tmp31->addChild(tmp32);
		HX_STACK_LINE(73)
		int tmp33 = stageWidth;		HX_STACK_VAR(tmp33,"tmp33");
		HX_STACK_LINE(73)
		int tmp34 = stageHeight;		HX_STACK_VAR(tmp34,"tmp34");
		HX_STACK_LINE(73)
		this->onResize(tmp33,tmp34);
		HX_STACK_LINE(76)
		::flixel::_system::frontEnds::SoundFrontEnd tmp35 = ::flixel::FlxG_obj::sound;		HX_STACK_VAR(tmp35,"tmp35");
		HX_STACK_LINE(76)
		::openfl::_legacy::media::Sound tmp36;		HX_STACK_VAR(tmp36,"tmp36");
		HX_STACK_LINE(76)
		{
			HX_STACK_LINE(76)
			...
			HX_STACK_LINE(76)
			::String tmp37 = (HX_HCSTRING("flixel/sounds/flixel","\x54","\x41","\xd6","\x5d") + extension);		HX_STACK_VAR(tmp37,"tmp37");
			HX_STACK_LINE(76)
			tmp36 = ::openfl::_legacy::Assets_obj::getSound(tmp37,null());
		}
		HX_STACK_LINE(76)
		::flixel::_system::FlxSound tmp37 = tmp35->__Field(HX_HCSTRING("load","\x26","\x9a","\xb7","\x47"), hx::paccDynamic )(tmp36,null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(tmp37,"tmp37");
		HX_STACK_LINE(76)
		tmp37->__Field(HX_HCSTRING("play","\xf4","\x2d","\x5a","\x4a"), hx::paccDynamic )(null());
	}
return null();
}
...
Void FlxSplash_obj::onComplete( ::flixel::tweens::FlxTween Tween){
{
		...
		HX_STACK_LINE(193)
		::openfl::_legacy::text::TextField tmp9 = this->_text;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(193)
		tmp8->removeChild(tmp9);
		HX_STACK_LINE(194)
		{
			HX_STACK_LINE(194)
			::hx::Class tmp10 = ::flixel::_system::FlxSplash_obj::nextState;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(194)
			::flixel::FlxState tmp11 = ::Type_obj::createInstance(tmp10,cpp::ArrayBase_obj::__new());		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(194)
			::flixel::FlxState nextState = tmp11;		HX_STACK_VAR(nextState,"nextState");
			HX_STACK_LINE(194)
			::flixel::FlxGame tmp12 = ::flixel::FlxG_obj::game;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(194)
			::flixel::FlxState tmp13 = nextState;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(194)
			bool tmp14 = tmp12->_state->switchTo(tmp13);		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(194)
			if ((tmp14)){
				HX_STACK_LINE(194)
				::flixel::FlxGame tmp15 = ::flixel::FlxG_obj::game;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(194)
				tmp15->_requestedState = nextState;
			}
		}
		HX_STACK_LINE(195)
		::flixel::FlxGame tmp10 = ::flixel::FlxG_obj::game;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(195)
		tmp10->_gameJustStarted = true;
	}
return null();
}
