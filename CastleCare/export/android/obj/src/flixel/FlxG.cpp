...
Void FlxG_obj::init( ::flixel::FlxGame Game,int Width,int Height,Float Zoom){
{
		...
		HX_STACK_LINE(534)
		::flixel::input::touch::FlxTouchManager tmp10 = ::flixel::input::touch::FlxTouchManager_obj::__new();		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(534)
		::flixel::input::touch::FlxTouchManager tmp11 = tmp9->__Field(HX_HCSTRING("add_flixel_input_touch_FlxTouchManager","\xe6","\xdb","\x13","\x1c"), hx::paccDynamic )(tmp10);		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(534)
		::flixel::FlxG_obj::touches = tmp11;
		HX_STACK_LINE(538)
		::flixel::_system::frontEnds::InputFrontEnd tmp12 = ::flixel::FlxG_obj::inputs;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(538)
		::flixel::input::gamepad::FlxGamepadManager tmp13 = ::flixel::input::gamepad::FlxGamepadManager_obj::__new();		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(538)
		::flixel::input::gamepad::FlxGamepadManager tmp14 = tmp12->__Field(HX_HCSTRING("add_flixel_input_gamepad_FlxGamepadManager","\x26","\xa8","\x4b","\x80"), hx::paccDynamic )(tmp13);		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(538)
		::flixel::FlxG_obj::gamepads = tmp14;
		HX_STACK_LINE(542)
		::flixel::_system::frontEnds::InputFrontEnd tmp15 = ::flixel::FlxG_obj::inputs;		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(542)
		::flixel::input::android::FlxAndroidKeys tmp16 = ::flixel::input::android::FlxAndroidKeys_obj::__new();		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(542)
		::flixel::input::android::FlxAndroidKeys tmp17 = tmp15->__Field(HX_HCSTRING("add_flixel_input_android_FlxAndroidKeys","\x5b","\x5d","\x92","\xe6"), hx::paccDynamic )(tmp16);		HX_STACK_VAR(tmp17,"tmp17");
		HX_STACK_LINE(542)
		::flixel::FlxG_obj::android = tmp17;
		HX_STACK_LINE(546)
		::flixel::input::FlxAccelerometer tmp18 = ::flixel::input::FlxAccelerometer_obj::__new();		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(546)
		::flixel::FlxG_obj::accelerometer = tmp18;
		HX_STACK_LINE(548)
		::flixel::util::FlxSave tmp19 = ::flixel::FlxG_obj::save;		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(548)
		tmp19->bind(HX_HCSTRING("flixel","\x5c","\x42","\x70","\x3d"));
		HX_STACK_LINE(550)
		::flixel::_system::frontEnds::PluginFrontEnd tmp20 = ::flixel::_system::frontEnds::PluginFrontEnd_obj::__new();		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(550)
		::flixel::FlxG_obj::plugins = tmp20;
		HX_STACK_LINE(551)
		::flixel::_system::frontEnds::VCRFrontEnd tmp21 = ::flixel::_system::frontEnds::VCRFrontEnd_obj::__new();		HX_STACK_VAR(tmp21,"tmp21");
		HX_STACK_LINE(551)
		::flixel::FlxG_obj::vcr = tmp21;
		HX_STACK_LINE(554)
		::flixel::_system::frontEnds::SoundFrontEnd tmp22 = ::flixel::_system::frontEnds::SoundFrontEnd_obj::__new();		HX_STACK_VAR(tmp22,"tmp22");
		HX_STACK_LINE(554)
		::flixel::FlxG_obj::sound = tmp22;
	}
return null();
}
