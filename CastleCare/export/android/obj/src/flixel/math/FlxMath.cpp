...
int FlxMath_obj::distanceToTouch( ::flixel::FlxSprite Sprite,::flixel::input::touch::FlxTouch Touch){
	HX_STACK_FRAME("flixel.math.FlxMath","distanceToTouch",0xd2645107,"flixel.math.FlxMath.distanceToTouch","flixel/math/FlxMath.hx",430,0x837802f8)
	HX_STACK_ARG(Sprite,"Sprite")
...
bool IncludeEqual = __o_IncludeEqual.Default(false);
	HX_STACK_FRAME("flixel.math.FlxMath","isDistanceToTouchWithin",0x33e8e188,"flixel.math.FlxMath.isDistanceToTouchWithin","flixel/math/FlxMath.hx",446,0x837802f8)
	HX_STACK_ARG(Sprite,"Sprite")
	HX_STACK_ARG(Touch,"Touch")
	HX_STACK_ARG(Distance,"Distance")
	HX_STACK_ARG(IncludeEqual,"IncludeEqual")
