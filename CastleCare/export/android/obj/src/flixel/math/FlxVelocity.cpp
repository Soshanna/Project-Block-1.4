...
Float Speed = __o_Speed.Default(60);
int MaxTime = __o_MaxTime.Default(0);
	HX_STACK_FRAME("flixel.math.FlxVelocity","moveTowardsTouch",0x60a86a07,"flixel.math.FlxVelocity.moveTowardsTouch","flixel/math/FlxVelocity.hx",96,0xbea30ec3)
	HX_STACK_ARG(Source,"Source")
	...
	HX_STACK_ARG(MaxTime,"MaxTime")
{
		...
		HX_STACK_LINE(97)
		{
			...
			bool AsDegrees = false;		HX_STACK_VAR(AsDegrees,"AsDegrees");
			HX_STACK_LINE(97)
			::flixel::math::FlxPoint tmp1 = Source->getScreenPosition(null(),null());		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(97)
...
{
		HX_STACK_FRAME("flixel.math.FlxVelocity","accelerateTowardsTouch",0x35889e13,"flixel.math.FlxVelocity.accelerateTowardsTouch","flixel/math/FlxVelocity.hx",142,0xbea30ec3)
		HX_STACK_ARG(Source,"Source")
		HX_STACK_ARG(Touch,"Touch")
		HX_STACK_ARG(Acceleration,"Acceleration")
		HX_STACK_ARG(MaxSpeed,"MaxSpeed")
