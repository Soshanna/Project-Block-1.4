...
Float Y = __o_Y.Default(0);
{
	...
	tmp6->set(null(),null());
	HX_STACK_LINE(225)
	this->statusAnimations[(int)1] = HX_HCSTRING("normal","\x27","\x72","\x69","\x30");
	HX_STACK_LINE(226)
	this->labelAlphas[(int)1] = (int)1;
	HX_STACK_LINE(229)
	::flixel::input::FlxInput tmp7 = ::flixel::input::FlxInput_obj::__new((int)0);		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(229)
	this->input = tmp7;
}
;
...
Void FlxTypedButton_flixel_text_FlxText_obj::updateButton( ){
{
		...
		HX_STACK_LINE(385)
		::flixel::input::IFlxInput tmp3 = this->currentInput;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(385)
		...
		if ((tmp5)){
			...
			HX_STACK_LINE(385)
			::flixel::input::IFlxInput tmp9 = tmp8;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(385)
			tmp6 = tmp9->get_justReleased();
		}
		else{
			HX_STACK_LINE(385)
			tmp6 = false;
		...
		if ((tmp7)){
			HX_STACK_LINE(385)
			::flixel::input::IFlxInput tmp9 = this->currentInput;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(385)
			::flixel::input::IFlxInput tmp10 = tmp9;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(385)
			::flixel::input::IFlxInput tmp11 = tmp10;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(385)
			::flixel::input::IFlxInput tmp12 = tmp11;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(385)
			::flixel::input::IFlxInput tmp13 = tmp12;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(385)
			tmp8 = ::Std_obj::is(tmp13,hx::ClassOf< ::flixel::input::touch::FlxTouch >());
		}
		else{
			HX_STACK_LINE(385)
			tmp8 = false;
		...
		if ((tmp11)){
			HX_STACK_LINE(392)
			bool tmp13 = overlapFound;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(392)
			...
			if ((tmp21)){
				HX_STACK_LINE(392)
				::flixel::input::IFlxInput tmp22 = this->currentInput;		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(392)
				::flixel::input::IFlxInput tmp23 = tmp22;		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(392)
				...
				if ((tmp29)){
					HX_STACK_LINE(392)
					::flixel::input::IFlxInput tmp30 = this->currentInput;		HX_STACK_VAR(tmp30,"tmp30");
					HX_STACK_LINE(392)
					::flixel::input::IFlxInput tmp31 = tmp30;		HX_STACK_VAR(tmp31,"tmp31");
					HX_STACK_LINE(392)
					::flixel::input::IFlxInput tmp32 = tmp31;		HX_STACK_VAR(tmp32,"tmp32");
					HX_STACK_LINE(392)
					::flixel::input::IFlxInput tmp33 = tmp32;		HX_STACK_VAR(tmp33,"tmp33");
					HX_STACK_LINE(392)
					tmp12 = tmp33->get_justReleased();
				}
				else{
					HX_STACK_LINE(392)
					tmp12 = false;
...
bool FlxTypedButton_flixel_text_FlxText_obj::checkMouseOverlap( ){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","checkMouseOverlap",0xab0126ff,"flixel.ui.FlxTypedButton_flixel_text_FlxText.checkMouseOverlap","flixel/ui/FlxButton.hx",414,0xc64cf442)
	HX_STACK_THIS(this)
	HX_STACK_LINE(414)
	return false;
}
...
bool FlxTypedButton_flixel_text_FlxText_obj::checkTouchOverlap( ){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","checkTouchOverlap",0xf3bdeca5,"flixel.ui.FlxTypedButton_flixel_text_FlxText.checkTouchOverlap","flixel/ui/FlxButton.hx",418,0xc64cf442)
	HX_STACK_THIS(this)
	HX_STACK_LINE(420)
	{
		HX_STACK_LINE(420)
		...
		while((true)){
			...
			HX_STACK_LINE(422)
			{
				...
				while((true)){
					...
					HX_STACK_LINE(424)
					::flixel::input::touch::FlxTouch tmp8 = touch;		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(424)
					::flixel::math::FlxPoint tmp9 = touch->justPressedPosition;		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(424)
					::flixel::FlxCamera tmp10 = camera;		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(424)
					bool tmp11 = this->checkInput(tmp7,tmp8,tmp9,tmp10);		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(424)
					if ((tmp11)){
						HX_STACK_LINE(426)
						return true;
