...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(29)
		::openfl::_legacy::Lib_obj::setPackage(HX_HCSTRING("HaxeFlixel","\x42","\x8f","\x0c","\xac"),HX_HCSTRING("Android_Test","\xe2","\xd6","\x85","\xdf"),HX_HCSTRING("com.Android.Test","\x7e","\xa2","\x00","\xb6"),HX_HCSTRING("0.0.1","\x35","\x3d","\xc8","\xc1"));
		HX_STACK_LINE(116)
		...
		HX_STACK_LINE(52)
		::openfl::_legacy::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)60,(int)16777215,tmp22,HX_HCSTRING("Android_Test","\xe2","\xd6","\x85","\xdf"),null(),null());
	}
return null();
}
