...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(29)
		::openfl::_legacy::Lib_obj::setPackage(HX_HCSTRING("F.Neeleman","\xfb","\xf3","\x7b","\x25"),HX_HCSTRING("CastleCare","\x09","\x15","\xf0","\x4c"),HX_HCSTRING("com.example.myapp","\x84","\x30","\x57","\xc1"),HX_HCSTRING("0.0.1","\x35","\x3d","\xc8","\xc1"));
		HX_STACK_LINE(116)
		...
		HX_STACK_LINE(52)
		::openfl::_legacy::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)60,(int)16777215,tmp22,HX_HCSTRING("CastleCare","\x09","\x15","\xf0","\x4c"),null(),null());
	}
return null();
}
