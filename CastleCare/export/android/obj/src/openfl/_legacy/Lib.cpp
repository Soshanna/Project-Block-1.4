...
Void Lib_obj::rethrow( Dynamic error){
{
		...
		if ((tmp8)){
			...
			HX_STACK_LINE(360)
			::String tmp12 = message;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(360)
			Dynamic tmp13 = hx::SourceInfo(HX_HCSTRING("Lib.hx","\xb9","\x80","\x1c","\x19"),360,HX_HCSTRING("openfl._legacy.Lib","\xc1","\xa5","\x5c","\xfc"),HX_HCSTRING("rethrow","\x93","\xb0","\x2a","\xf6"));		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(360)
