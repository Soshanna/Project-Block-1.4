...
Void SharedObject_obj::clear( ){
{
		...
		HX_STACK_LINE(42)
		::openfl::_legacy::net::SharedObject_obj::lime_clear_user_preference(tmp);
	}
return null();
}
	...
	HX_STACK_ARG(minDiskSpace,"minDiskSpace")
{
		...
		HX_STACK_LINE(129)
		::String tmp3 = encodedData;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(129)
		::openfl::_legacy::net::SharedObject_obj::lime_set_user_preference(tmp2,tmp3);
		HX_STACK_LINE(148)
	...
	HX_STACK_ARG(secure,"secure")
{
		...
		HX_STACK_LINE(172)
		::String tmp2 = ::openfl::_legacy::net::SharedObject_obj::lime_get_user_preference(tmp1);		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(172)
		::String rawData = tmp2;		HX_STACK_VAR(rawData,"rawData");
		...
		HX_STACK_LINE(187)
		Dynamic loadedData = tmp3;		HX_STACK_VAR(loadedData,"loadedData");
		HX_STACK_LINE(189)
		bool tmp4 = (rawData != HX_HCSTRING("","\x00","\x00","\x00","\x00"));		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(189)
		...
		if ((tmp5)){
			...
			{
				HX_STACK_LINE(193)
				::haxe::Unserializer tmp6 = ::haxe::Unserializer_obj::__new(rawData);		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(193)
				::haxe::Unserializer unserializer = tmp6;		HX_STACK_VAR(unserializer,"unserializer");
				HX_STACK_LINE(194)
				Dynamic tmp7 = ::Type_obj::resolveEnum_dyn();		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(194)
				Dynamic tmp8 = ::openfl::_legacy::net::SharedObject_obj::resolveClass_dyn();		HX_STACK_VAR(tmp8,"tmp8");
				struct _Function_3_1{
					inline static Dynamic Block( Dynamic &tmp7,Dynamic &tmp8){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_legacy/net/SharedObject.hx",194,0xecec0fc2)
						{
							hx::Anon __result = hx::Anon_obj::Create();
							__result->Add(HX_HCSTRING("resolveEnum","\x0d","\x90","\x51","\xde") , tmp7,false);
							__result->Add(HX_HCSTRING("resolveClass","\xac","\xbd","\xdd","\x80") , tmp8,false);
							return __result;
						}
						return null();
					}
				...
				HX_STACK_LINE(194)
				Dynamic tmp9 = _Function_3_1::Block(tmp7,tmp8);		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(194)
				Dynamic tmp10 = tmp9;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(194)
				unserializer->setResolver(tmp10);
				HX_STACK_LINE(195)
				Dynamic tmp11 = unserializer->unserialize();		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(195)
				loadedData = tmp11;
			}
			}
			catch(Dynamic __e){
				{
					...
					Dynamic e = __e;{
						HX_STACK_LINE(199)
						::String tmp6 = (HX_HCSTRING("Could not unserialize SharedObject: ","\xef","\xee","\xc6","\xae") + name);		HX_STACK_VAR(tmp6,"tmp6");
						HX_STACK_LINE(199)
						Dynamic tmp7 = hx::SourceInfo(HX_HCSTRING("SharedObject.hx","\xda","\x51","\x3d","\xf3"),199,HX_HCSTRING("openfl._legacy.net.SharedObject","\xf9","\x1d","\x0b","\xdf"),HX_HCSTRING("getLocal","\xf5","\xd8","\xc7","\xd8"));		HX_STACK_VAR(tmp7,"tmp7");
						HX_STACK_LINE(199)
		...
		HX_STACK_LINE(206)
		::openfl::_legacy::net::SharedObject tmp6 = ::openfl::_legacy::net::SharedObject_obj::__new(name,localPath,loadedData);		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(206)
		::openfl::_legacy::net::SharedObject so = tmp6;		HX_STACK_VAR(so,"so");
		HX_STACK_LINE(207)
		::openfl::_legacy::net::SharedObject tmp7 = so;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(207)
		return tmp7;
	}
}
...
{
	lime_get_user_preference= ::openfl::_legacy::Lib_obj::load(HX_HCSTRING("lime-legacy","\xc1","\x7f","\xb9","\x87"),HX_HCSTRING("lime_legacy_get_user_preference","\x1a","\x35","\x1c","\x59"),(int)1);
	lime_set_user_preference= ::openfl::_legacy::Lib_obj::load(HX_HCSTRING("lime-legacy","\xc1","\x7f","\xb9","\x87"),HX_HCSTRING("lime_legacy_set_user_preference","\x26","\x28","\xb9","\x95"),(int)2);
	lime_clear_user_preference= ::openfl::_legacy::Lib_obj::load(HX_HCSTRING("lime-legacy","\xc1","\x7f","\xb9","\x87"),HX_HCSTRING("lime_legacy_clear_user_preference","\x11","\xa9","\x3c","\xf1"),(int)1);
}
