...
Void GL_obj::uniformMatrix2fv( Dynamic location,bool transpose,::openfl::_legacy::utils::Float32Array v){
{
		...
		HX_STACK_LINE(1078)
		::openfl::_legacy::utils::ByteArray tmp3 = v->getByteBuffer();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(1078)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform_matrix(tmp1,tmp2,tmp3,(int)2);
	}
return null();
}
...
Void GL_obj::uniformMatrix3fv( Dynamic location,bool transpose,::openfl::_legacy::utils::Float32Array v){
{
		...
		::openfl::_legacy::utils::ByteArray tmp3 = v->getByteBuffer();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(1088)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform_matrix(tmp1,tmp2,tmp3,(int)3);
	}
return null();
}
...
Void GL_obj::uniformMatrix4fv( Dynamic location,bool transpose,::openfl::_legacy::utils::Float32Array v){
{
		...
		::openfl::_legacy::utils::ByteArray tmp3 = v->getByteBuffer();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(1099)
		::openfl::_legacy::gl::GL_obj::lime_gl_uniform_matrix(tmp1,tmp2,tmp3,(int)4);
	}
return null();
}
