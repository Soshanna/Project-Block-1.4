...
Void Accelerometer_obj::__update( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(70)
		::openfl::events::AccelerometerEvent tmp = ::openfl::events::AccelerometerEvent_obj::__new(HX_HCSTRING("update","\x09","\x86","\x05","\x87"),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(70)
		::openfl::events::AccelerometerEvent event = tmp;		HX_STACK_VAR(event,"event");
		HX_STACK_LINE(71)
		Dynamic tmp1 = ::openfl::_legacy::sensors::Accelerometer_obj::lime_input_get_acceleration();		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(71)
		Dynamic data = tmp1;		HX_STACK_VAR(data,"data");
		HX_STACK_LINE(73)
		Float tmp2 = ::haxe::Timer_obj::stamp();		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(73)
		event->timestamp = tmp2;
		HX_STACK_LINE(74)
		...
		HX_STACK_LINE(78)
		::openfl::events::AccelerometerEvent tmp3 = event;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(78)
