...
::Sys_obj::__register();
::upgrade::UpgradeRoomState_obj::__register();
::upgrade::UpgradeMenuState_obj::__register();
::upgrade::UpgradeInteriorState_obj::__register();
...
::menu::OverState_obj::__register();
::menu::OptionsState_obj::__register();
::menu::MenuState_obj::__register();
::menu::CreditsState_obj::__register();
